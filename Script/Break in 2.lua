...
Section:Set("Note:", "Getting/Spamming Multiple Of 1 Type Of Items May Cause The Item To Break And Be Unuseable/Unequippable.\nIt Is Recommended To Only Grab 1 Item At Once, Especially If Its An Item Everyone Can Use.")
...
local Section = Tab:CreateSection("Heal Yourself")
...
local Toggle = Tab:CreateToggle({
   ...
   Callback = function(Value)
   					...
   					if SemiGodmode == true then
   						Rayfield:Notify({
   						   Title = "What Semi-Godmode Works On: Special Attacks (Pizza Boss's Pepper Attack, All Scarry Larry/Marry Attacks Except Monster Spawner), Hailing And Possibly Some Others\nWhat Semi-Godmode Doesnt Work On: Enemies, Ice (Use Anti Slip), Getting Locked In A Room While An Enemy Wave Comes, And Possibly Some Others",
...
local Button = Tab:CreateButton({
   Name = "Scarry Marry Pillar",
   Callback = function()
   TeleportTo(CFrame.new(-1501.49597, -325.156891, -1060.63367, -0.691015959, 7.43958628e-09, 0.722839475, -5.03345055e-09, 1, -2.1273511e-08, -0.995669007, -1.72383299e-08, 0.0929690823))
   end,
})
...
local Section = Tab:CreateSection("NPC's")
...
local Button = Tab:CreateButton({
   Name = "Get All Item From Outside",
   Callback = function()
			GetAllOutsideItems()
   end,
})
